...
\title{Aplikacja internetowa wspomagająca planowanie diety} % INFO: tytuł pracy w języku polskim 
\titleShort{Aplikacja internetowa ...}  % INFO: krótki tytuł pracy (do zamieszczenia w stopce, sklejony z imieniem i nazwiskiem autora nie powinien zająć więcej niż jedną linijkę)
%\titleEN{Engineering/master thesis template, version 0.9} % INFO: tytuł pracy w języku angielskim
\author{Janusz Pelc}  % INFO: imię i nazwisko autora
...
\promotor{Dr inż. Jarosław Mierzwa} % INFO: dane promotora 
